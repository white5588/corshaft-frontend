...
const Shortlet = () => {
 ...
 <div className='flex gap-2 '>
    ...
    <div className='px-4 py-2   flex bg-[dodgerblue] hover:scale-105 cursor-pointer hover:text-[silver] transition-all rounded-sm'> Search</div>
 </div>

<div className='flex flex-row gap-5'>
    <div className='px-4 py-2 flex bg-[dodgerblue] text-tl cursor-pointer rounded-sm'>Type</div>
    <div className='px-4 py-2  flex bg-[dodgerblue] text-tl cursor-pointer rounded-sm'>Room</div>
    <div className='px-4 py-2 flex bg-[dodgerblue] text-tl cursor-pointer rounded-sm'>Price</div>
    <div className='px-4 py-2 flex bg-[dodgerblue] text-tl cursor-pointer rounded-sm'>Price</div>
</div>
